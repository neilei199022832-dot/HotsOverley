...
export function findByName (name: HeroNames) {return allHeroes.find(hero => hero.name === name)!}

export function finedByNames (names: HeroNames[]){return  names.map(name => findByName(name))}